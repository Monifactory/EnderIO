...
public class LootCapacitorItem extends CapacitorItem implements IMultiCapabilityItem {
    ...
    public Component getName(ItemStack pStack) {
        var capacitorData = pStack.getCapability(EIOCapabilities.CAPACITOR).resolve().orElseThrow();
