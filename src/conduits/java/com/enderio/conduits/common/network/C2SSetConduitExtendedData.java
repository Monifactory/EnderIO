...
public class C2SSetConduitExtendedData implements Packet {
    ...
    public C2SSetConduitExtendedData(BlockPos pos, ConduitType<?> conduitType, ExtendedConduitData<?> extendedConduitData) {
        this.pos = pos;
    ...
    public C2SSetConduitExtendedData(FriendlyByteBuf buf) {
        ...
        conduitType = ConduitRegistries.getRegistry().getValue(buf.readResourceLocation());
    ...
    protected void write(FriendlyByteBuf writeInto) {
        ...
        writeInto.writeResourceLocation(ConduitRegistries.getRegistry().getKey(conduitType));
